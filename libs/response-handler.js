...
// const debug = require('./logger-handler').debugger(__filename);
const lodash = require("lodash");
const constants = require(`${__dirname}/../constants/response-codes`);
const responseLogger = require("../libs/logger-handler").responseLogger;
/**
...
module.exports = function (err, res, resCode, resData, req) {
  // debug(err, resCode, resData);

  if (req) {
    responseLogger(err, req, resCode, resData);
  }
